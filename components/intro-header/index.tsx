...
import { MovieVideoType } from '@/models/tmdb/movie/movieVideos'
import { useGetMovieVideosQuery, useGetPopularMoviesQuery } from '@/redux/api/tmdb/movieAPI'
...
const IntroHeader: FC<Props> = () => {
  ...
  return (
    <div className="w-full relative bg-tmrev-gray-dark h-[400px]">
      <Image
        alt={`${firstMovie.title} backdrop`}
        className="opacity-30"
        layout="fill"
